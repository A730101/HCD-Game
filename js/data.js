...
const charConfigs = {
    ...
    fisherman: {
        ...
        // Companion recruitment dialogues
        companionDialogs: {
            // Solo recruitment
            ahjie: [
                "【阿傑加入了隊伍】\n\n我熟練地幫阿傑把車發動了起來。",
                "阿傑：「阿星你這手法...比我還熟？你不是只會釣魚嗎？」",
                "我：「欸，我也是有看你改車的啊。再五分鐘就修好！」",
                "阿傑：「...這次還真的五分鐘。」\n\n他露出了難得的笑容。",
                "我：「以前跟你借車的錢...要不要算了？」",
                "阿傑：「想得美！不過先欠著吧，活下來再說。」",
                "【我們踏上了逃亡之路】"
            ...
            richkid: [
                "【包子加入了隊伍】\n\n我把包子從樹叢裡拉了出來。",
                "包子：「學長！我就知道你會來救我！」",
                "我：「別高興太早，你那些VIP卡能幫我們逃命嗎？」",
                "包子：「學長你不懂，這張黑卡可以...算了，現在ATM都不能用了。」\n\n他苦笑著。",
                "我：「那你以前欠我的那些請客...」",
                "包子：「學長！現在是說這個的時候嗎？！」",
                "我：「哈，開玩笑的。走吧，這次換我保護你。」",
                "包子：「學長...」\n\n他眼眶有點紅。",
            ...
            shanji: [
                ...
                "山雞：「阿星...好久不見。」",
                "我：「從包子告白被拒後，就沒怎麼聯絡了吧。」",
                "山雞：「...那件事你還記得啊。我只是不想讓他知道東方錶面的真相。」",
                "我：「現在真相都攤在眼前了。你還恨包子嗎？」",
                "山雞：「不...我只想活下去。阿星，跟我們一起吧。」",
                "我：「好。這次不再互相隱瞞了。」",
                "【新的同盟誕生】"
            ],
            // Multi-companion recruitment
            "ahjie+richkid": [
                "【包子加入了隊伍】\n\n我把包子從樹叢裡拉了出來。",
                "包子：「學長！我就知道你會...咦？阿傑也在？」",
                "阿傑：「包子？你怎麼搞成這樣？」",
                "包子：「別提了...我的保鑣全跑了，VIP卡也沒用...」",
                "我：「行了，現在我們三個湊齊了。還記得之前約好的烤肉嗎？」",
                "阿傑：「哈，沒想到是在這種情況下聚在一起。」",
                "包子：「學長，阿傑，這次我絕對不會拖後腿的！」",
                "阿傑：「你能不被喪屍咬就不錯了。」",
                "包子：「喂！我可是有錢...算了，活下來比什麼都重要。」",
                "我：「好兄弟就該一起活著走出去。走吧！」",
                "【三人組成立】"
            ],
            "ahjie+shanji": [
                "【山雞加入了隊伍】\n\n山雞看到我們，愣了一下。",
                "山雞：「阿星...你旁邊這位是？」",
                "我：「這是阿傑，我的好兄弟。阿傑，這是山雞。」",
                "阿傑：「妳好。阿星常提到妳...好像跟包子有過節？」",
                "山雞：「...是的。不過現在不是談這個的時候。」",
                "我：「山雞，妳帶著這麼多倖存者...還願意跟我們一起嗎？」",
                "山雞：「我需要你的釣魚技術幫大家找食物。交換條件，我的人可以提供保護。」",
                "阿傑：「聽起來是個不錯的合作。阿星，你覺得呢？」",
                "我：「山雞，我們是朋友。不用談什麼交換，一起活下去就好。」",
                "山雞：「...謝謝。那我就不客氣了。」",
                "【新的隊伍組成】"
            ],
            "ahjie+richkid+shanji": [
                "【山雞加入了隊伍】\n\n山雞帶著倖存者走來，看到我們愣住了。",
                "山雞：「阿星...還有包子？！你旁邊這位是...？」",
                "包子：「山...山雞？！」\n\n氣氛突然凝重起來。",
                "我：「這是阿傑，我的好兄弟。」",
                "阿傑：「欸欸，這什麼修羅場啊？你們兩個有恩怨？」",
                "我：「都什麼時候了，過去的事就算了吧。」",
                "包子：「山雞...對不起，以前的事...」",
                "山雞：「...算了。我早就放下了。」",
                "阿傑：「喂喂，氣氛有點沉重啊。阿星，你這些朋友都好有故事。」",
                "我：「現在末日了，過去的恩怨都不重要了。我們該團結起來。」",
                "包子：「阿星說得對。山雞，我們...重新開始？」",
                "山雞：「...好。為了活下去。」",
                "阿傑：「這才對嘛！走，我們一起殺出去！」",
                "【完整隊伍集結】"
